            ...
            if let Some(help) = candidate.get_help() {
                write!(
                    ...
                    Self::escape_help(
                        {
                            #[cfg(feature = "color")]
                            let s = help.ansi().to_string();
                            #[cfg(not(feature = "color"))]
                            let s = help.to_string();
                            s
                        }
                        .lines()
                        .next()
