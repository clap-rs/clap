_my-app() {
    ...
    case "${cmd}" in
        ...
        my__app__subcmd__help__subcmd__help)
            ...
            return 0
            ;;
        my__app__subcmd__help__subcmd__some__subcmd__cmd__subcmd__with__subcmd__hyphens)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        my__app__subcmd__help__subcmd__some__subcmd__hidden__subcmd__cmd)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        my__app__subcmd__help__subcmd__some_cmd)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        my__app__subcmd__help__subcmd__test)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        my__app__subcmd__some__subcmd__cmd__subcmd__with__subcmd__hyphens)
            ...
            return 0
            ;;
        my__app__subcmd__some__subcmd__hidden__subcmd__cmd)
            opts="-h -V --help --version"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
