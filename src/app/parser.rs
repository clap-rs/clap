...
fn count_arg<'a, 'b>(a: &mut Arg<'a, 'b>, positionals: &mut VecMap<&'a str>, num_opts: &mut usize, num_flags: &mut usize) {
    // Count types
    ...
    'b: 'c,
{
    ...
    fn _build(&mut self) {
        ...
        for a in &mut self.app.args {
            ...
            count_arg(a, &mut self.positionals, &mut self.num_opts, &mut self.num_flags);
        }
