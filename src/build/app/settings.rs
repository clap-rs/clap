...
pub enum AppSettings {
    ...
    /// Prints the autogenerated help and version messages to stderr instead of stdout.
    ///
    /// # Examples
    ///
    /// ```no_run
    /// # use clap::{App, AppSettings};
    /// App::new("myprog")
    ///    .global_setting(AppSettings::PrintToStderr)
    ///   .get_matches();
    /// ```
    PrintToStderr,
