...
impl ErrorKind {
    ...
    pub fn as_str(self) -> Option<&'static str> {
        Some(match self {
            Self::InvalidValue => "one of the values isn't valid for an argument",
            Self::UnknownArgument => "unexpected argument found",
            Self::InvalidSubcommand => "unrecognized subcommand",
            Self::NoEquals => "equal is needed when assigning values to one of the arguments",
            Self::ValueValidation => "invalid value for one of the arguments",
            Self::TooManyValues => "unexpected value for an argument found",
            Self::TooFewValues => "more values required for an argument",
            Self::WrongNumberOfValues => "too many or too few values for an argument",
            Self::ArgumentConflict => {
                "an argument cannot be used with one or more of the other specified arguments"
            }
            Self::MissingRequiredArgument => "one or more required arguments were not provided",
            Self::MissingSubcommand => "a subcommand is required but one was not provided",
            Self::InvalidUtf8 => "invalid UTF-8 was detected in one or more arguments",
            Self::DisplayHelp
            | Self::DisplayHelpOnMissingArgumentOrSubcommand
            | Self::DisplayVersion
            | Self::Io
