...
fn posix_compatible_flags_long() {
    let m = App::new("posix")
        .arg(
            Arg::from_usage("--flag  'some flag'").overrides_with("color"),
        )
...
fn posix_compatible_flags_short() {
    let m = App::new("posix")
        .arg(
            Arg::from_usage("-f, --flag  'some flag'").overrides_with("color"),
        )
...
fn posix_compatible_opts_long() {
    let m = App::new("posix")
        .arg(
            Arg::from_usage("--flag [flag] 'some flag'").overrides_with("color"),
        )
...
fn posix_compatible_opts_short() {
    let m = App::new("posix")
        .arg(
            Arg::from_usage("-f [flag]  'some flag'").overrides_with("c"),
        )
        .arg(Arg::from_usage("-c [color] 'some other flag'"))
...
fn conflict_overriden() {
    let m = App::new("conflict_overriden")
        .arg(
            Arg::from_usage("-f, --flag 'some flag'").conflicts_with("debug"),
        )
        .arg(Arg::from_usage("-d, --debug 'other flag'"))
        .arg(
            Arg::from_usage("-c, --color 'third flag'").overrides_with("flag"),
        )
...
fn pos_required_overridden_by_flag() {
    let result = App::new("require_overriden")
        ...
        .arg(
            Arg::from_usage("-c, --color 'some flag'").overrides_with("pos"),
        )
...
fn require_overriden_2() {
    let m = App::new("require_overriden")
        ...
        .arg(
            Arg::from_usage("-c, --color 'other flag'").overrides_with("flag"),
        )
