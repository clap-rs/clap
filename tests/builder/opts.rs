...
fn did_you_mean() {
    static DYM: &str = "\
error: Found value '--optio' which wasn't expected, or isn't valid in this context
...
error: Found value '--files-without-matches' which wasn't expected, or isn't valid in this context
