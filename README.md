...
[![License](https://img.shields.io/badge/license-Apache%202.0-blue?style=flat-square)](https://github.com/clap-rs/clap/blob/v3.1.2/LICENSE-APACHE)
[![License](https://img.shields.io/badge/license-MIT-blue?style=flat-square)](https://github.com/clap-rs/clap/blob/v3.1.2/LICENSE-MIT)
...
1. [About](#about)
2. Tutorial: [Builder API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_builder/README.md),  [Derive API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_derive/README.md)
3. [Examples](https://github.com/clap-rs/clap/blob/v3.1.2/examples/README.md)
...
5. [CHANGELOG](https://github.com/clap-rs/clap/blob/v3.1.2/CHANGELOG.md)
6. [FAQ](https://github.com/clap-rs/clap/blob/v3.1.2/docs/FAQ.md)
7. [Questions & Discussions](https://github.com/clap-rs/clap/discussions)
8. [Contributing](https://github.com/clap-rs/clap/blob/v3.1.2/CONTRIBUTING.md)
8. [Sponsors](#sponsors)
...
This uses our
[Derive API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_derive/README.md)
which provides access to the [Builder API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_builder/README.md) as attributes on a `struct`:
...
Why use the declarative [Derive API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_derive/README.md):
- Easier to read, write, and modify
- Easier to keep the argument declaration and reading of argument in sync
- Easier to reuse, e.g. [clap-verbosity-flag](https://crates.io/crates/clap-verbosity-flag)

Why use the procedural [Builder API](https://github.com/clap-rs/clap/blob/v3.1.2/examples/tutorial_builder/README.md):
