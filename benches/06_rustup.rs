...
pub fn build_cli() -> App<'static, 'static> {
    App::new("rustup")
        ...
        .set(AppSettings::VersionlessSubcommands)
        ...
        .subcommand(App::new("install")
            ...
            .set(AppSettings::Hidden) // synonym for 'toolchain install'
            .arg(Arg::new("toolchain")
                .required(true)))
        .subcommand(App::new("update")
            .about("Update Rust toolchains")
            .after_help(UPDATE_HELP)
            .arg(Arg::new("toolchain").required(false))
        ...
        .subcommand(App::new("toolchain")
            ...
            .subcommand(App::new("update")
                .set(AppSettings::Hidden) // synonym for 'install'
                .arg(Arg::new("toolchain")
                .required(true)))
            ...
            .subcommand(App::new("remove")
                .set(AppSettings::Hidden) // synonym for 'uninstall'
                .arg(Arg::new("toolchain")
                     .required(true))))
        .subcommand(App::new("target")
            ...
            .subcommand(App::new("remove")
                ...
                .arg(Arg::new("toolchain")
                    ...
                    .set(ArgSettings::TakesValue)))
            .subcommand(App::new("install")
                .set(AppSettings::Hidden) // synonym for 'add'
                .arg(Arg::new("target")
                    .required(true))
                .arg(Arg::new("toolchain")
                    .long("toolchain")
                    .set(ArgSettings::TakesValue)))
            .subcommand(App::new("uninstall")
                .set(AppSettings::Hidden) // synonym for 'remove'
                .arg(Arg::new("target")
                    .required(true))
                .arg(Arg::new("toolchain")
                    .long("toolchain")
        ...
        .subcommand(App::new("override")
            ...
            .subcommand(App::new("unset")
                ...
                .arg(Arg::new("nonexistent")
                    .long("nonexistent")
                    .takes_value(false)
                    .help("Remove override toolchain for all nonexistent directories")))
            .subcommand(App::new("add")
                .set(AppSettings::Hidden) // synonym for 'set'
                .arg(Arg::new("toolchain")
                     .required(true)))
            .subcommand(App::new("remove")
                .set(AppSettings::Hidden) // synonym for 'unset'
                .about("Remove the override toolchain for a directory")
                .arg(Arg::new("path")
                    .long("path")
                    .set(ArgSettings::TakesValue))
