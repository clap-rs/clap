...
fn parse_lots(b: &mut Bencher) {
    b.iter(|| {
        app_short().get_matches_from(vec!["rg", "pat", "some", "some", "some", "some", "some",
    ...
    where F: Fn(&'static str) -> &'static str
{
    ...
    App::new("ripgrep")
        ...
        .arg(flag("regexp").short("e")
             .set(ArgSettings::TakesValue).multiple(true).number_of_values(1)
        ...
        .arg(flag("after-context").short("A")
             .value_name("NUM").set(ArgSettings::TakesValue)
        ...
        .arg(flag("context-separator")
             .value_name("SEPARATOR").set(ArgSettings::TakesValue))
        .arg(flag("debug"))
        .arg(flag("file").short("f")
             .value_name("FILE").set(ArgSettings::TakesValue)
        ...
        .arg(flag("max-count")
             .short("m").value_name("NUM").set(ArgSettings::TakesValue)
             .validator(validate_number))
        .arg(flag("maxdepth")
             .value_name("NUM").set(ArgSettings::TakesValue)
             .validator(validate_number))
        ...
        .arg(flag("null"))
        .arg(flag("path-separator").value_name("SEPARATOR").set(ArgSettings::TakesValue))
        .arg(flag("pretty").short("p"))
        .arg(flag("replace").short("r").value_name("ARG").set(ArgSettings::TakesValue))
        .arg(flag("case-sensitive").short("s"))
        .arg(flag("smart-case").short("S"))
        .arg(flag("sort-files"))
        .arg(flag("threads")
             .short("j").value_name("ARG").set(ArgSettings::TakesValue)
             .validator(validate_number))
        .arg(flag("vimgrep"))
        .arg(flag("type-add")
             .value_name("TYPE").set(ArgSettings::TakesValue)
             .multiple(true).number_of_values(1))
        .arg(flag("type-clear")
             .value_name("TYPE").set(ArgSettings::TakesValue)
             .multiple(true).number_of_values(1))
