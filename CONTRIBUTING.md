...
|------------------------------------------------------|---------------|---------|-------------|
| [v4](https://github.com/clap-rs/clap/tree/main)    | active        | Features and bug fixes target `main` by default | TBD |
| [v3](https://github.com/clap-rs/clap/tree/v3-main) | maintenance   | Accepting trivial cherry-picks from `main` (i.e. minimal conflict resolution) by contributors and fixes for ecosystem-wide showstoppers | TBD |
| [v2](https://github.com/clap-rs/clap/tree/v2-main) | deprecated    | Only accepting fixes for ecosystem-wide showstoppers | TBD |
| v1                                                   | unsupported   | \- | \- |
